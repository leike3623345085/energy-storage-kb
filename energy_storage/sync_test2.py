...
# 字段ID映射 (从 feishu_bitable_list_fields 获取)
FIELD_IDS = {
    "时间": "fldRFNOBro",      # DateTime
    "来源": "fldKz71J7w",      # Text
    "标题": "fldQm23dU2",      # Text
    "内容": "fldGTasg5u",      # Text
    "URL": "fldfWy9y9L",       # URL
...
try:
    ...
    # 构建记录 - 使用字段ID
    record = {
        FIELD_IDS["时间"]: timestamp_ms,
        FIELD_IDS["来源"]: source,
        FIELD_IDS["标题"]: title,
        FIELD_IDS["内容"]: title[:100],
        FIELD_IDS["URL"]: {"text": "查看原文", "link": link},
        FIELD_IDS["网站"]: source
    }
